...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const dataRetrieved = await AsyncStorage.getItem(dataKey);
    const responseData = dataRetrieved ? JSON.parse(dataRetrieved) : [];
    const updatedData = [...responseData, newLoginData];
